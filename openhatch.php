...
<head>
	...
	<title>OpenHatch Open Source Workshop - ACM Reflections | Projections 2012</title>
...
<body>
<?php $page="openhatch.php"; include("nav.php") ?>
<div id="wrap">
	<div id="page-description" class="container-fluid">
		<div class="row" id="header">
			<div id="top-section">
			<div class="span12">
				<h1 class="page-heading">Open Source Workshop by OpenHatch</h1>
			</div>
		</div>
		</div>
	</div>
	<div id="main" class="container">
		...
		<div class="row openhatch-row">
			...
			<div id="dont_oh" class="openhatch-info span6">
				<div class="hero-unit">
		...
		<div class="row openhatch-row">
			<div id="do_oh" class="openhatch-info span6">
				<div class="hero-unit">
