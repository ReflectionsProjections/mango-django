			...
			<div id="homepage-span6">
				<div class="span6">
					<div class="hero-unit well" id="homepage-hero">
						<h2 class="home-links"><a href="./registration.php"><div class="crarr left"></div><small>Registration for</small> Attendees<div class="crarr right"></div></a></h2>
						<h2 class="home-links"><a href="./mechmania.php"><div class="crarr left"></div><small>Registration for</small> Mechmania<div class="crarr right"></div></a></h2>
						<h2 class="home-links"><a href="./volunteers.php"><div class="crarr left"></div><small>Registration for</small> Volunteers<div class="crarr right"></div></a></h2>
						<br/>
