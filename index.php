			...
			<div id="homepage-span6">
				<div class="span6">
					<div class="hero-unit well" id="homepage-hero">
						<h2 class="home-links"><a href="http://www.youtube.com/playlist?list=PLcEFyjv8seq4cH2PL7_r_hOU2Ax6aeAlg&feature=view_all"><div class="crarr left"></div><div class="crarr right"></div>Watch Videos</a></h2>
						<br/>
